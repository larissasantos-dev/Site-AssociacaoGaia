document.addEventListener('DOMContentLoaded', () => {
    ...
    mobileBtnMenu.setAttribute('role', 'button');
    mobileBtnMenu.setAttribute('tabindex', '0');
    mobileBtnMenu.setAttribute('aria-label', 'Abrir menu de navegação');
    mobileBtnMenu.setAttribute('aria-controls', 'mobile-header-sidebar');
    mobileBtnMenu.setAttribute('aria-expanded', 'false');

    mobileBtnMenu.addEventListener('click', () => {
        sidebar.classList.add('active');
        overlay.classList.add('active');
        mobileBtnMenu.setAttribute('aria-expanded', 'true');
    });
    mobileBtnMenu.addEventListener('keydown', (event) => {
